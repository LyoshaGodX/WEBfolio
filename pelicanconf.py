...
SKILLS_TAGS = ['Pascal', 'Алгебра', 'Алгоритмы', 'Безопасность жизнедеятельности', 'Копирайт', 'Курсовая работа', 'Математический анализ', 'Матричные вычисления', 'Программирование', 'Работа с текстом', 'Символьные вычисления', 'Софт', 'Спорт', 'Физика', 'Четкая логика']
